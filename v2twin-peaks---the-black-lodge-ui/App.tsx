...
const App = () => {
  ...
  const typedLogResponse = useTypewriter(logResponse || "I hold many secrets. Ask.", 30);
    ...
    <div className="relative min-h-screen w-full bg-black text-white overflow-hidden font-serif">
      ...
      <div className="relative z-10 flex flex-col min-h-screen pointer-events-none">
        ...
        <header className="pt-16 pb-8 text-center pointer-events-auto">
          <h1 className="text-6xl md:text-9xl font-serif italic text-transparent bg-clip-text bg-gradient-to-b from-red-500 via-red-700 to-black tracking-tighter drop-shadow-[0_0_15px_rgba(255,0,0,0.6)]"
        ...
        <main className="flex-1 w-full max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          ...
          <div className="md:col-span-5 flex flex-col items-end gap-8 pointer-events-auto order-2 md:order-1">
              ...
              <div className="space-y-8 w-full flex flex-col items-center md:items-end perspective-1000">
                  <Button3D 
          ...
          <div className="md:col-span-7 flex justify-center md:justify-start pointer-events-auto order-1 md:order-2">
              <div className="w-full max-w-lg min-h-[500px] backdrop-blur-md bg-black/40 border border-white/10 p-10 rounded-sm shadow-[0_0_50px_rgba(0,0,0,0.5)] relative overflow-hidden group transition-all duration-1000 hover:shadow-[0_0_80px_rgba(138,12,12,0.4)]">
                  ...
                  {currentView === 'LODGE' && (
                      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center animate-fade-in">
                          <div className="mb-8 relative">
                              <div className={`absolute inset-0 bg-red-500 blur-2xl transition-opacity duration-1000 rounded-full ${isLoading ? 'opacity-40 animate-pulse' : 'opacity-0'}`}></div>
                              <div className="w-40 h-40 rounded-full bg-[#1a1a1a] border-2 border-[#3a3a3a] shadow-2xl flex items-center justify-center relative overflow-hidden grayscale hover:grayscale-0 transition-all duration-700">
                                  ...
                                  <div className="w-24 h-64 bg-[#3d2b1f] rotate-12 absolute shadow-[inset_0_0_20px_rgba(0,0,0,0.8)]" style={{ backgroundImage: 'repeating-linear-gradient(45deg, transparent, transparent 10px, rgba(0,0,0,0.2) 10px, rgba(0,0,0,0.2) 20px)' }}></div>
                                  <span className="text-6xl relative z-10 drop-shadow-lg mix-blend-overlay opacity-50">🪵</span>
                              </div>
                          </div>
                          
                          <h2 className="text-3xl text-red-100 mb-2 font-light italic">The Oracle Log</h2>
                          
                          <div className="min-h-[120px] flex items-center justify-center px-4 mb-8">
                             <p className={`text-xl font-mono leading-relaxed transition-colors duration-500 ${isLoading ? 'text-red-400' : 'text-gray-300'}`}>
                                 "{typedLogResponse}"
                  ...
                  {currentView === 'PALMER' && (
                      <div className="relative z-10 h-full flex flex-col animate-fade-in">
                          ...
                          <div className="space-y-6 font-mono text-sm text-blue-200/80 flex-1">
                              <div className="flex gap-4 p-4 bg-blue-900/10 rounded border border-blue-500/10 transform hover:scale-[1.02] transition-transform">
                                  <div className="w-24 h-24 bg-black border border-blue-500/20 flex items-center justify-center shrink-0 overflow-hidden">
                              ...
                              <div className="p-4 bg-red-900/10 rounded border border-red-500/10 text-red-200/80 transform hover:scale-[1.02] transition-transform">
